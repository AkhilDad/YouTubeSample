...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!appSharedPreferences.getBoolean(AppSharedPreferences.PreferenceKeys.IS_LOGGED_IN, false)) {
...
//        mPlaylistRV.setAdapter();
        new VideoLoaderAsyncTask().execute();
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_playlist1) {

        } else if (id == R.id.nav_playlist2) {

        } else if (id == R.id.nav_playlist3) {
